...
namespace PersonalMethod {
	...
	public:
		...
		huffman_node* huffman_tree_create(std::map<unsigned char, int>& word, std::map<unsigned char, std::string>& res);
	...
	private:
		...
		void print_huffman_pre(huffman_node* pnode, std::map<unsigned char, std::string>& res);
	...
	public:
		...
		static std::string UnsignedCharToString(unsigned char c);
